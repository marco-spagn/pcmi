...
- **gRPC API** (`GRPC_PORT`, default 50051) — Store / BatchStore (stessi campi di `POST /v1/memories`), Retrieve (stessi filtri di `POST /v1/retrieve`), batch/stream, Health, Ready  
