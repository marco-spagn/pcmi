...
export COVERAGE_MIN_TOTAL="${COVERAGE_MIN_TOTAL:-39}"
export COVERAGE_PKG_FLOORS="${COVERAGE_PKG_FLOORS:-config:70,event:70,eventschema:85,repository:70,service:70,worker:19}"
